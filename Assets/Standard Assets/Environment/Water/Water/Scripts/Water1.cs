...
namespace UnityStandardAssets.Water1
{
    ...
    public class Water1 : MonoBehaviour
    {
        ...
        void CreateWaterObjects(Camera currentCamera, out Camera reflectionCamera, out Camera refractionCamera)
        {
            ...
            if (mode >= WaterMode.Reflective)
            {
                ...
                {
                    GameObject go = new GameObject("Water1 Refl Camera id" + GetInstanceID() + " for " + currentCamera.GetInstanceID(), typeof(Camera), typeof(Skybox));
            ...
            if (mode >= WaterMode.Refractive)
            {
                ...
                {
                    GameObject go =
                        new GameObject("Water1 Refr Camera id" + GetInstanceID() + " for " + currentCamera.GetInstanceID(),
